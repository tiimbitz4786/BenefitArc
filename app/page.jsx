      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '40px 24px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            Financial analytics and forecasting tools built specifically for 
            Social Security Disability law practices.
          </p>
        </header>
        ...
        <section>
          ...
          <div style={{ 
            ...
            <ComingSoonCard
              ...
              description="Track and forecast your case pipeline from intake through resolution with stage-by-stage analytics."
            />
            <ComingSoonCard
              title="Marketing ROI Calculator"
              description="Measure marketing effectiveness by channel and calculate true cost per signed case."
            />
            <ComingSoonCard
              title="Staffing Optimizer"
              description="Model optimal staffing levels based on caseload, case mix, and productivity targets."
            />
          </div>
        </section>
        ...
        <footer style={{ 
          ...
          <p style={{ color: '#475569', fontSize: '12px' }}>
            BenefitArc Tools • Built for Social Security Disability Practices
          </p>
