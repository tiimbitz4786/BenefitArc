...
const client = new Client({
  host: 'db.cnhaupfppygomlnxlfqu.supabase.co',
  port: 5432,
  database: 'postgres',
  user: 'postgres.cnhaupfppygomlnxlfqu',
...
DROP POLICY IF EXISTS "Authenticated users can insert snapshots" ON kpi_snapshots;
DROP POLICY IF EXISTS "Service role can read snapshots" ON kpi_snapshots;
